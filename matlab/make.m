...
try
	...
	% Add -largeArrayDims on 64-bit machines of MATLAB
	   ...
	   % mex CFLAGS="-x c++ -v" -largeArrayDims libsvmwrite.c
		mex CFLAGS="-O3 -march=native -ffast-math" -largeArrayDims train.c linear_model_matlab.c ../l2r_l2_primal_fun.cpp ../l2r_huber_primal_fun.cpp ../linear.cpp ../SAG.cpp "../blas/*.c"
		mex CFLAGS="-O3 -march=native -ffast-math" -largeArrayDims predict.c linear_model_matlab.c ../l2r_l2_primal_fun.cpp ../l2r_huber_primal_fun.cpp ../linear.cpp ../SAG.cpp "../blas/*.c"
	end
catch
